...
function BigpapiColorSwatch({ teamID }) {
  ...
  return (
    <div className="branding-color" style={{ position: 'relative', width: 100 }}>
      <div
        className="branding-color-swatch"
        style={{ background: hex, cursor: 'pointer', width: 100, height: 48, borderTopLeftRadius: 8, borderTopRightRadius: 8, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, border: '1.5px solid #222', boxSizing: 'border-box', position: 'relative' }}
        title="Click to copy hex"
        onClick={handleCopy}
      >
        {copied && (
