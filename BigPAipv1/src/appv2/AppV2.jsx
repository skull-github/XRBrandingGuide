      ...
      {revealed && (
        <div style={{ marginTop: 18, width: '100%' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, marginBottom: 40 }}>
            ...
            {/* Branding JSON Color Swatches */}
            <h4 style={{ fontSize: 18, fontWeight: 700, color: '#fff', margin: '0 0 1.5rem 0', letterSpacing: 1, textAlign: 'left' }}>Branding JSON Color Swatches</h4>
            ...
            {/* MLB.TV Assets Section */}
            {team.mlbtv && <MLBTVGallery mlbtv={team.mlbtv} />}
          </div>
        </div>
      )}
    </div>
